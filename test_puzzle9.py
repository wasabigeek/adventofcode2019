...
class Test(unittest.TestCase):
    def test_execute(self):
        ...
        inputs = []
        _, outputs, _, _ = execute(intcode, inputs)
...
class RegressionTest(unittest.TestCase):
    ...
    def test_jump_if_false(self):
        ...
        self.do_instruction(
            ...
            intcode=[6, 0, 5],
            input=None,
            expected_intcode=[6, 0, 5], expected_next_index=5, expected_output=None)
        ...
        self.do_instruction(
            ...
            intcode=[6, 1, 5],
            input=None,
            expected_intcode=[6, 1, 5], expected_next_index=3, expected_output=None)
    ...
    def test_less_than(self):
        _less_than = less_than(param_1_mode=get_immediate, param_2_mode=get_immediate, param_3_mode=get_from_pos)
    ...
    def test_equals(self):
        _equals = equals(param_1_mode=get_immediate, param_2_mode=get_immediate, param_3_mode=get_from_pos)
